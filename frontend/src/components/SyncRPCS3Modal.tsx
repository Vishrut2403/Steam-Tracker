...
const SyncRPCS3Modal: React.FC<SyncRPCS3ModalProps> = ({ isOpen, onClose, onSync, userId }) => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-2xl font-bold text-[#e5e5e5] mb-4">Sync RPCS3 Data</h2>
        ...
        {isLoading && (
          <div className="text-center py-8">
            ...
            <p className="text-[#a0a0a0]">Syncing RPCS3 data...</p>
            <p className="text-sm text-[#696969] mt-2">Reading playtime and trophy files</p>
          </div>
        )}
        ...
        {syncResult && (
          <div className="space-y-4">
            <div className="p-4 bg-[#3a4a3a] border border-[#5a7fa3] rounded">
              <h3 className="text-[#7a9fc3] font-semibold mb-2">🕹️ Playtime</h3>
            ...
            <p className="text-center text-[#696969] text-sm">Refreshing library...</p>
          </div>
        )}
      </div>
    </div>
